...
if nargin < 3
 ...
 if ~isempty(ah)
  ...
  supAxes=[leftMin-axBuf,bottomMin-axBuf,leftMax-leftMin+axBuf*2,bottomMax-bottomMin+axBuf*2-heightBuf];
 end
end
...
supAxes(1) = 0.1;
supAxes(3) = 0.8;
supAxes(2) = max(supAxes(2), 0.2);
supAxes(4) = min(supAxes(4), 1-supAxes(2)+heightBuf);
