...
patients(22).subj='DBS048';
patients(22).T_date = '160427';
patients(22).dataFile = {'LT1D0.522'};
patients(22).tasks = {'GoAntiGo'};

patients(21).subj='DBS047';
patients(21).T_date = '160406';
patients(21).dataFile = {'RT1D1.984'};
patients(21).tasks = {'GoAntiGo'};

patients(20).subj='DBS046';
patients(20).T_date = '160323';
patients(20).dataFile = {'RT1D-1.997'};
patients(20).tasks = {'GoAntiGo'};

patients(19).subj='DBS045';
patients(19).T_date = '160224';
patients(19).dataFile = {'LT1D2.092'};
patients(19).tasks = {'GoAntiGo'};
