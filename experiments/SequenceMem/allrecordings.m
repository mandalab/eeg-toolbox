...
patients(19).subj='DBS048';
patients(19).T_date = '160427';
patients(19).dataFile = {'LT1D0.522'; 'RT1D1.047'};
patients(19).tasks = {'SequenceMem'; 'SequenceMem'};

patients(18).subj='DBS047';
patients(18).T_date = '160406';
patients(18).dataFile = {'LT1D-1.604'; 'RT1D1.984'};
patients(18).tasks = {'SequenceMem'; 'SequenceMem'};

patients(17).subj='DBS046';
patients(17).T_date = '160323';
patients(17).dataFile = {'RT1D-1.997'};
patients(17).tasks = {'SequenceMem'};

patients(16).subj='DBS045';
patients(16).T_date = '160224';
patients(16).dataFile = {'LT1D2.254'; 'RT1D-0.001'; 'RT1D-0.529'};
patients(16).tasks = {'SequenceMem'; 'SequenceMem'; 'SequenceMem'};

patients(15).subj='DBS044';
patients(15).T_date = '160205';
patients(15).dataFile = {'LT1D0.800'};
patients(15).tasks = {'SequenceMem'};
...
for patient=1:length(patients)
    ...
    if isfield(patients, 'BRdataFile') && (~isempty(patients(patient).BRdataFile) || ~isempty(patients(patient).NKdataFile))
