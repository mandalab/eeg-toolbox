...
try
    ...
    fprintf('\n could not retrieve tal struct');  %- supress warning for NIH processing of data
end
...
if foundTal
    ...
    if exist(jackFile,'file')
        ...
        fprintf('\n WARNING: COULD NOT GET TALAIRACH STRUCTURE OR JACKSHEET!!!!');  %- JW downgrades to a text warning... if somebody needs this they can dig for it
