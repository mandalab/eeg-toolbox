function subjectInfo = getPalRamUtahSubjInfo(subj,sessNum)
% Get info about patients who did palram with utah arrays
% keyboard
br_fileName = '';
nk_sessName = '';
subjectInfo = struct;
allSubjNames = {'NIH029','NIH030','NIH034','NIH037','NIH039','NIH042'};

if strcmp(subj,'NIH029') || (isnumeric(subj) && subj == 29)
    whichHemi = 'lh';
    adjacentGridElecs = [10,11,18,19];
    utahChanCount = 96;
    utahChanJacksheetName = {'UTAH_INF'};
...
elseif strcmp(subj,'NIH037') || (isnumeric(subj) && subj == 37)
    ...
    utahChanCount = 96;
    utahChanJacksheetName = {'UTAH_POS','UTAH_ANT'};
...
subjectInfo.whichHemi = whichHemi;
subjectInfo.allSubjNames = allSubjNames;
...
subjectInfo.utahChanJacksheetName = utahChanJacksheetName;
