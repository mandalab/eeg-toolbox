...
while true
    ...
    switch upper(thisTYPE)
        ...
        case 'SESS_START' % this should be for pre-NIH048 (sys 2 RAM)
            ...
            events=RAM_PALrepeat_CreateTASKEvents_v2(subject,expDir,session,sessionDir,forceSESSION, startingElec);
            
               % events=RAM_PALrepeat_CreateTASKEvents(subject,expDir,session,sessionDir,forceSESSION, startingElec);
