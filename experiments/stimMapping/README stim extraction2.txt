...
II) extractStimEventsFromAnn_v10.m,  modified by TS 1/10/2016, (previously called createStimEvents_v3a.m)
JW cleaned up 8/2017 to fit better into prepAndAlign



%%%%%——  NIH036-ish to 40-ish?   —%%%%%
extractStimEventsFromOGstimLog_v4.m  modified by TS 12/2/2016, cleaned up by JW 9/2017 (previously called createStimEvents_v4.m)
eliminates annotation file processing… 
required trigDC10.sync file and stimLog
...
extractStimEventsFromStimLog_v10.m  created by TS, modified by CS and JW (previously called extractStimEvents_v2.m)
This extracts events from Tim’s stim mapping gui’s outputs.  This is how it should be done!
JW cleaned up 8/2017 so it creates a fake/replica session.log that helps with prepAndAlign alignment
