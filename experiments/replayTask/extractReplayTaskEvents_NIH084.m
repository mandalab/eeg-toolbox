function [events] = extractReplayTaskEvents_NIH084(rootEEGdir, subject, sessionName)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% % sessionDir = '/Volumes/EEG_56STAGE-1/stage/working/NIH084/behavioral/replayTask/session_0';
% subject     = 'NIH084';   % NIHXXX
