...
if exist('org.apache.poi.ss.usermodel.WorkbookFactory', 'class') ~= 8 ...
    ...
    xlwriteLoc = which('xlwrite');
    thispwd    = xlwriteLoc(1:end-9);
    javaaddpath([thispwd 'poi_library/poi-3.8-20120326.jar']);
    javaaddpath([thispwd 'poi_library/poi-ooxml-3.8-20120326.jar']);
    javaaddpath([thispwd 'poi_library/poi-ooxml-schemas-3.8-20120326.jar']);
    javaaddpath([thispwd 'poi_library/xmlbeans-2.3.0.jar']);
    javaaddpath([thispwd 'poi_library/dom4j-1.6.1.jar']);
    javaaddpath([thispwd 'poi_library/stax-api-1.0.1.jar']);
    
    %- now double check that the addpath worked
    if exist('org.apache.poi.ss.usermodel.WorkbookFactory', 'class') ~= 8 ...
            || exist('org.apache.poi.hssf.usermodel.HSSFWorkbook', 'class') ~= 8 ...
            || exist('org.apache.poi.xssf.usermodel.XSSFWorkbook', 'class') ~= 8
