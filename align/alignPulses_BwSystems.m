function [signalLag,corrStrength] = alignPulses_BwSystems(pulses_1,pulses_2,figSaveDir,whichDC,toSave)
%extractUtahEphys
...
plot_ts_gui(match_size(s1_al_bin,s2_al_bin),'scroll',0)
...
if whichDC==12
    pulseTrainStart_i = find(diff(ts_unaltered)>500)+1;
