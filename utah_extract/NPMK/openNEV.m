...
% 
% 3/12/2020: SJ added 1 manual fix from previous version, but changed (Flags.SaveFile = 'nosave';) to
% instead keyboard if not 'nosave'
%
...
%(manual change)
if ~strcmpi(Flags.SaveFile,'nosave')
    fprintf('\n%s\n','STOP!! Need to add nosave to openNEV call. Currently set to save. Ask SJ!');
    keyboard
end
