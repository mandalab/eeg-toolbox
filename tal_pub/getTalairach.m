...
%
% INPUTS:
%   vertex or XYZ - node (1 to 198,812) from the std 141 tesselation or a length-3 vector
%
% OPTIONAL:
...
atlas_table = afni_extract_whereami('xyz', xyz_tal, 'atlas', 'TT_Daemon', 'orientation', 'RAI', 'run',true);
